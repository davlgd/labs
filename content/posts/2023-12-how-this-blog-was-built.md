...
tags:
  ...
  - Tutorials
  - Web
ogImage: /images/2023-12-build-technical-blog.webp
---

I've been publishing personal thoughts [on a blog](https://www.davlgd.fr/on-my-way-to-42.html) for several years, and I'd planned to post on a technical blog in English for quite some time. It's now done.
...
Astro is a great modern tool, easy to deploy. I cut trackers on this theme, and there is [an RSS feed](https://labs.davlgd.com/rss.xml)! Of course, I tried it on [Clever Cloud](https://clever-cloud.com) in many ways and I'm now close to what I consider a perfect pipeline.
